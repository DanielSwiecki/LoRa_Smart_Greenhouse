...
function saveDataAndSensorValuesToFile($rawData, $sensorValues) {
    // Specify the relative path to the log file in the same directory as the script
    $logFilePath = 'log_helium.txt';
    ...
    // Append the combined data to the log file in the same directory as the script
    file_put_contents($logFilePath, $combinedData, FILE_APPEND);
}
